...
| Ανάλυση Απαιτήσεων | Μόνο ίχνη FR10/FR11 σε σχόλια του `app.py` — **η λίστα FR/NFR δεν υπάρχει στο repo** | Πλήρης λίστα FR + NFR (γράψε την πρώτη — όλα τα επόμενα κεφάλαια δένουν πάνω της) |
| Σχεδίαση (διαγράμματα) | Η αρχιτεκτονική είναι καθαρή (data → features → models → app) | Context, component, class/ER, use-case + 1 activity/sequence **ανά use case** |
...
| Βαθμός Ικανοποίησης Απαιτήσεων | — | Πίνακας FR→βαθμός· εδώ αξιοποίησε τα Β1.1–Β1.4 (ό,τι δεν φτιαχτεί, αιτιολογείται έντιμα) |
